   ...
   <div class="nav-space">
     <div>
       <li class="nav-item pt-3">
         <a class="nav-link .nav-tabs" href="http://localhost:2000/">
       ...
       <li  class="nav-item ">
         <a class="nav-link" href="http://localhost:2000/employee">
       ...
       <li v-if="['developer','admin'].includes(user.role)" class="nav-item ">
         <a class="nav-link" href="http://localhost:2000/management">
