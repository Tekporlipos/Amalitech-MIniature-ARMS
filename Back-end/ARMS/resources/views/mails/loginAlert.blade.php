        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            <div class="p-6 ">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://amalitech.com/" class="underline text-gray-900 dark:text-white">{{$device['userName']}}</a></div>
                </div>
                    ...
                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                     ...
                     <p>{{$device["message"]}}</p>
                      ...
                      <br>
                        ...
                        <br>
                        <blockquote>
                            <b class="container">If you did not make this request kindly login and change your credentials, Thank you.</b>
                        </blockquote>
